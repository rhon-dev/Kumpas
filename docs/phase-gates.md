...
| 2 | CNN-LSTM baseline + experiment log | 🔄 Notebook ready (`training/notebooks/kumpas_cnn_lstm_training.ipynb`) — awaiting Colab run | Adviser reviews confusion matrix |
